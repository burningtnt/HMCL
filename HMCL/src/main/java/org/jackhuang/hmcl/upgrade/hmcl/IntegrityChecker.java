...
public final class IntegrityChecker {
    ...
    public static final boolean DISABLE_SELF_INTEGRITY_CHECK = "true".equals(net.burningtnt.hmclprs.Hooks.onInitDisableSelfIntegrityCheckProperty(System.getProperty("hmcl.self_integrity_check.disable")));
