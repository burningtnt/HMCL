...
public final class Metadata {
    ...
    public static final String VERSION = net.burningtnt.hmclprs.hooks.PRCollectionBootstrap.onInitApplicationVersion(System.getProperty("hmcl.version.override", JarUtils.getAttribute("hmcl.version", "@develop@")));
